...
<div id="{{ cookiecutter.module }}_content">
    <!-- FILTER MODAL -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="advanceSearch">
                        <div class="row">
                        {% for field, details in cookiecutter.fields.items() %}{% if details.meta.label %}
                            <div class="form-group col-md-6">
                                <label class="form-control-label">{{ details.meta.label }}:</label>
                                {% if details.meta.form_elem is defined %}
                                    {% if details.meta.is_one == "True" %}                                
                                    <select class="form-control suggests_modal" style="width:100%;"
                                            data-module="{{ details.meta.table }}" id="{{ field }}"
                                            name="{{ field }}">
                                        <option value="">Select {{ details.meta.label }}</option>
                                    </select>                            
                                    {% endif %}
                                    ...
                                    {% if details.meta.form_elem == "select" %}
                                        <select class="form-control" id="{{ field }}" name="{{ field }}">
                                            <option v-for="{{ details.meta.module }} in sources.{{table}}" :value="{{ details.meta.module }}.id">
                                                -- replace --
                                            </option>
                                        </select>
                                    {% endif %}
        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
                    <input type="text" class="form-control" placeholder="Search {{ cookiecutter.module_name }}..."
                           id="generalSearch">
    ...
    <div class="module__cta">
        <div class="kt-container  kt-container--fluid ">
            <div class="module__create">
                <a href="<?php echo site_url('{{ cookiecutter.module }}/form'); ?>"
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="kt-input-icon  kt-input-icon--left">
                                        <input type="text" name="{{ cookiecutter.module }}_id"
                                               class="form-control form-control-sm _filter" placeholder="ID"
                                               id="_column_1"
                                               data-column="1">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="kt-input-icon  kt-input-icon--left">
                                        <input type="text" name="{{ cookiecutter.module }}_name"
            ...
            <div id="_batch_upload" class="collapse kt-margin-b-35 kt-margin-t-10">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="_export_csv"
                              action="<?php echo site_url('{{ cookiecutter.module }}/export_csv'); ?>"
                        ...
                        <form class="kt-form" id="_upload_form"
                              action="<?php echo site_url('{{ cookiecutter.module }}/import'); ?>"
                              method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label">Upload CSV file:</label>
                                        <label class="form-control-label text-muted">Note: Maximum of 1,000 items only
                                            per
                                            file.</label>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable"
                ...
                <tr>
                    ...
                    <th>{{ details.meta.label }}</th>{% endif %}
                    {% endfor %}
                    <th>Actions</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="kt-form" id="_export_form" target="_blank"
                          action="<?php echo site_url('{{ cookiecutter.module }}/export'); ?>" method="POST">
                        <div class="row">
                            <div class="col-lg-12">
    ...
    <div class="modal fade" id="upload_guide" tabindex="-1" role="dialog" aria-labelledby="upload_guide_label"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"
                            class="btn btn-secondary btn-elevate btn-outline-hover-brand btn-sm btn-icon-sm"
                            data-dismiss="modal">
